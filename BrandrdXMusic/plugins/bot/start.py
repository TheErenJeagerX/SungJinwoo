...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAyEFAASHqdIzAAIHL2d6RN8AAVcLK0buex6yHsA1BONwRAACNRAAAqaj-VcT-7l3nAAB0FceBA")
        ...
        out = private_panel(_)
        await message.reply_sticker("CAACAgUAAyEFAASHqdIzAAIHMGd6ROTyFEWGiJAGhZUAATTCGencrQAC_Q4AApYF-VehhyBwJZuUXx4E")
